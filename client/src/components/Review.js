...
// Import antd
import { Steps, List, Form, Input, Button, Divider } from 'antd';
...
export class Review extends Component {
    render() {
        return (
            ...
            <Steps current={0}>
                <Steps.Step title="Responses" />
                <Steps.Step title="Resume" />
                <Steps.Step title="Scoring" />
            </Steps>
            ...
            <Form>
                ...
                >
                    <Input.Search 
                        ...
                        size="large"
                        enterButton={<Button type="primary" htmlType="submit">
                        Submit
                    </Button>}
                    />
                </Form.Item>
